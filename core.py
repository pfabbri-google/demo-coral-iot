...
class CloudIot:
    ...
    def __init__(self, config_file=CONFIG_DEFAULT, config_section='DEFAULT'):
        """
        Args:
        ...
        self._token_thread = threading.Thread(
            target=self._token_update_loop, 
            args=(self._term_event,))
